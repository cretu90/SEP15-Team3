...
Der Inhalt des ersten Milestones besteht einerseits aus den kritischen Arbeitspaketen und zum Anderen aus
...
Außerdem wird der \kursiv{PropertyManager} implementiert, welcher dafür zuständig ist, die nötigen Parameter aus den Konfigurationsdateien zu laden.
...
benötigten Initialisierungen durchgeführt werden, wie das Einlesen der Propertydateien, die Erstellung der Datenbanktabellen und Initialisierung des \kursiv{DatabaseConnectionManagers}.
