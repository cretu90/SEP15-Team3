	...
	\begin{itemize}
		...
		\item \method{public void Address setAddress(Address addressToSet)}
	\end{itemize}
	...
	\begin{itemize}
		...
		\item \method{public Address getAddress()}
		\item \method{public void setAddress(Addres addressToSet)}
	...
	\begin{itemize}
		...
		\item \method{public ArrayList<CourseUnits> getSelectedCourseUnits()}
		\item \method{public void setSelectedCourseUnits(ArrayList<CourseUnits> selectedCourseUnits)}
	...
	Dieses Package stellt Interfaces zur Verfügung, welche die DAO - Klassen implementieren müssen damit gegebenenfalls  ein Wechsel der Datenbank einfach möglich ist.
		...
		\begin{itemize}
			...
			\item \method{public ArrayList<Courses> getCoursesLeadedBy(int userID, Pagination pagination)}
		\end{itemize}
	...
	\subsection{Package DatabaseGeneral}
		...
		\class{Klasse DatabaseTableCreator}
		...
		\class{Klasse DatabaseTableDetroyer}
