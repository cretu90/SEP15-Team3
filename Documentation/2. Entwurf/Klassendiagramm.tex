	...
	\subsection{Package DatabaseGeneral}
		...
		\begin{itemize}
			\item \method{public boolean createInitialAdmin() throws InvalidDatabaseTransferException}
	...
	\subsection{Package DAO}
		...
		\begin{itemize}
			...
			\item \method{public boolean addUserToCourseUnit(int userID)}
			\item \method{public boolean removeUserFromCourseUnit(int userID)}
			\item \method{poblic boolean getCourseUnitsOf(int userID)}
		\end{itemize}
	...
	\begin{center}
		\includegraphics[width=1.0\linewidth]{Grafiken/OfCourseFinalumlcd}
