\chapter{View}
		...
		KH\\
			\begin{itemize}
				...
				\item \textbf{Links:}
					\begin{itemize}
						\item Startseite: Über diesen Link gelangt der Benutzer zurück zur Startseite. (\hyperlink{index}{index.xhtml}) \\Ziel: 
					\end{itemize}
				\item \textbf{Buttons:} -
				\item \textbf{Inputs:} -
				\item \textbf{Outputs:}
			...
			\begin{itemize}
				...
				\begin{center}
					\begin{longtable}{|p{4cm} |p{4cm} | p{4cm}|p{3cm}|}
						...
						\hline \multicolumn{1}{|c|}{\textbf{Feld}} & \multicolumn{1}{|c|}{\textbf{Action}} & \multicolumn{1}{|c|}{\textbf{JSF-Tag}} &  \multicolumn{1}{|c|}{\textbf{Scope}} \\ \hline
						\endfirsthead
						\hline
						\endlastfoot
							\textit{Anrede (R)} & AuthenticateAction & inputText & Request\\ \hline
							\textit{Vorname (R)} & AuthenticateAction & inputText & Request\\ \hline
							\textit{Name (R)} & AuthenticateAction & inputText & Request\\ \hline
							\textit{Benutzername (R)} & AuthenticateAction & inputText & Request\\ \hline
							\textit{Passwort (R)} & AuthenticateAction & inputSecret & Request\\ \hline
							\textit{Passwort bestätigen (R)} & AuthenticateAction & inputText & Request\\ \hline
							\textit{Geburtstag (R)} & AuthenticateAction & inputText & Request\\ \hline
							\textit{Straße/ Hausnummer (R)} & AuthenticateAction & inputText & Request\\ \hline
							\textit{Stadt (R)} & AuthenticateAction & inputText & Request\\ \hline
							\textit{Postleitzahl (R)} & AuthenticateAction & inputText & Request\\ \hline
							\textit{Land (R)} & AuthenticateAction & inputText & Request\\ \hline
							\textit{E-Mail-Adresse (R)} & AuthenticateAction & inputText & Request\\ \hline
							\textit{AGBs bestätigen (R)} & AuthenticateAction & inputText & Request\\ \hline
							\textit{Benutzername (A)} & AuthenticateAction & inputText & Request\\ \hline
							\textit{Passwort (A)} & AuthenticateAction & inputText & Request\\ \hline
							\textit{E-Mail-Adresse (Passwort vergessen)} & AuthenticateAction & inputText & Request\\ \hline
					\end{longtable}
				\end{center}
