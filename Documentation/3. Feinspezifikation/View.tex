			...
			\end{itemize}
				...
				\begin{center}
					\begin{longtable}{|p{5cm} | p{4cm}|p{3cm}|}
						...
						\hline
						\endlastfoot
						\textit{Anrede Fehlermeldung (R)}  & outputText & ... \\ \hline
			...
			\item \textbf{Outputs:}
				...
				\begin{center}
					\begin{longtable}{|p{5cm} | p{4cm}|p{3cm}|}
						...
						\textit{Startzeit (Fehlermeldung)}  & outputText & ... \\ \hline
						\textit{Endzeit (Fehlermeldung)}  & outputText & ... \\ \hline
						\textit{Straße/ Hausnummer (Fehlermeldung) }  & outputText & ... \\ \hline
						\textit{Postleitzahl (Fehlermeldung)} & outputText & ... \\ \hline
						\textit{Stadt (Fehlermeldung)} & outputText & ... \\ \hline
			...
			\item \textbf{Inputs:}
				...
				\begin{center}
					\begin{longtable}{|p{3cm} |p{5cm} | p{4cm}|p{3cm}|}
						...
						\hline
						\endlastfoot
						\textit{Benutzer aktivieren} & AccountManagement. User.userStatus & selectBooleanCheckbox & ... \\ \hline
					\end{longtable}
				\end{center}
			...
			\item \textbf{Outputs:}
				...
				\begin{center}
					\begin{longtable}{|p{5cm} | p{4cm}|p{3cm}|}
						...
						\textit{Kurseinheiten Tabelle}  & dataTable & ... \\ \hline
						\textit{Kursbild}  & graphicImage & ... \\ \hline
					\end{longtable}
				\end{center}
			...
			\item \textbf{Inputs:}
				...
				\begin{center}
					\begin{longtable}{|p{3cm} |p{5cm} | p{4cm}|p{3cm}|}
						...
						\hline
						\endlastfoot
						\textit{Impressum} & EditImprint.system. impressum & inputText & ... \\ \hline
					\end{longtable}
				\end{center}
