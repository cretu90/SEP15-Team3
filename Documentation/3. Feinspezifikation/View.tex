		...
		\begin{itemize}
			...
			\begin{center}
				\begin{longtable}{|p{4cm} |p{6cm} |}
					...
					\textit{Suche} & -\\ \hline
					\textit{Sprache Deutsch} & language = ger\\ \hline
					\textit{Sprache Englisch} & language = eng\\ \hline
				...
				\end{itemize}
					 \begin{center}
					 	\begin{longtable}{|p{4cm} |p{6cm} | p{4cm}|}
					 		...
					 		\textit{Details} & loadCourseDetailsPageOfSelectedCourse() &  courseId (Id des ausgewählten Kurses wird übergeben) \\ \hline
					 	\end{longtable}
					 \end{center}
		...
		\begin{itemize}
			...
			\begin{center}
				\begin{longtable}{|p{4cm} |p{6cm} | p{4cm}|}
					...
					\textit{Impressum bearbeiten} & loadEditImprintPage() & - \\ \hline
				\end{longtable}
			\end{center}
			\item \textbf{Inputs:}
			\begin{itemize}
