			...
			\item \textbf{Outputs:}
				...
				\begin{center}
					\begin{longtable}{|p{5cm} | p{4cm}|p{3cm}|}
						...
						\hline
						\endlastfoot
						\textit{Kurstabelle}  & dataTable & ... \\ \hline
					\end{longtable}
				\end{center}
			...
			\item \textbf{Inputs:}
				...
				\begin{center}
					\begin{longtable}{|p{3cm} |p{5cm} | p{4cm}|p{3cm}|}
						...
						\hline
						\endlastfoot
						\textit{Vorname} & - & inputText & ... \\ \hline
						\textit{Name} & - & inputText & ... \\ \hline
						\textit{Geburtstag } & - & inputText & ... \\ \hline
						\textit{Straße/ Hausnummer} & - & inputText & ...\\ \hline
						\textit{Stadt} & - & inputText & ... \\ \hline
						\textit{Postleitzahl} & - & inputText & ... \\ \hline
						\textit{Land} & - & inputText & ... \\ \hline
						\textit{E-Mail-Adresse} & - & inputText & ...\\ \hline
						\textit{Benutzername} & - & inputText & ... \\ \hline
						\textit{Passwort} & - & inputSecret & ... \\ \hline
						\textit{Passwort bestätigen} & - & inputSecret & ... \\ \hline
						\textit{Benutzerrolle} & - & inputText & ... \\ \hline
						\textit{Profilbild} & - & inputText & ... \\ \hline
					\end{longtable}
				\end{center}
			...
			\item \textbf{Outputs:}
				...
				\begin{center}
					\begin{longtable}{|p{5cm} | p{4cm}|p{3cm}|}
						...
						\textit{Tabelle Trainingskurse} &  dataTable & ... \\ \hline
					\end{longtable}
				\end{center}
			...
			\end{itemize}
					\begin{center}
						\begin{longtable}{|p{5cm} | p{4cm}|p{3cm}|}
							...
							\hline
							\endlastfoot
							\textit{CVC-Nummer}  & outputText & ... \\ \hline
							\textit{Ablaufadtum}  & outputText & ... \\ \hline
							\textit{Nachname}  & outputText & ... \\ \hline
							\textit{Vorname}  & outputText & ... \\ \hline
							\textit{Kredit-Institut}  & outputText & ... \\ \hline
							\textit{Kreditkarten-nummer}  & outputText & ... \\ \hline
							\textit{Betrag}  & outputText & ... \\ \hline
						\end{longtable}
					\end{center}
			\item \textbf{BackingBean:}
			\begin{itemize}
		...
		\begin{itemize}
			...
			\begin{center}
				\begin{longtable}{|p{5cm} | p{4cm}|p{3cm}|}
					...
					\hline
					\endlastfoot
					\textit{Tabelle Kursleiterdaten}  & dataTable & ... \\ \hline
				\end{longtable}
			\end{center}
			...
			\begin{itemize}
				...
				\begin{center}
					\begin{longtable}{|p{3cm} |p{5cm} | p{4cm}|p{3cm}|}
						...
						\hline
						\endlastfoot
						\textit{Entfernen} & - & selectBooleanCheckbox & ... \\ \hline
					\end{longtable}
				\end{center}
			...
			\item \textbf{Inputs:}
				...
				\begin{center}
					\begin{longtable}{|p{3cm} |p{5cm} | p{4cm}|p{3cm}|}
						...
						\hline
						\endlastfoot
						\textit{Termin} & - & inputText & ... \\ \hline
						\textit{Straße/ Hausnummer} & - & inputText & ...\\ \hline
						\textit{Postleitzahl} & - & inputText & ... \\ \hline
						\textit{Stadt} & - & inputText & ... \\ \hline
						\textit{Ort} & - & inputText & ... \\ \hline
						\textit{Beschreibung} & - & inputText & ...\\ \hline
						\textit{Preis} & - & inputText & ... \\ \hline
						\textit{Kursleiter} & - & inputText & ... \\ \hline
						\textit{Mindestteil- nehmerzahl} & - & inputText & ... \\ \hline
						\textit{Maximale Teilnehmerzahl} & - & inputText & ... \\ \hline
						...
						\textit{Checkbox regelmäßig} & - & selectBooleanCheckbox & ... \\ \hline
			...
			\end{itemize}
					...
					\begin{center}
						\begin{longtable}{|p{5cm} | p{4cm}|p{3cm}|}
							...
							\endlastfoot
							\textit{Benutzer-ID}  & outputText & ... \\ \hline
							\textit{Benutzername}  & outputText & ... \\ \hline
							\textit{Betrag} & outputText & ...\\ \hline
							\textit{Überziehungswert} & outputText & ...\\ \hline
						\end{longtable}
					\end{center}
			\item \textbf{BackingBean:}
			\begin{itemize}
			...
			\begin{itemize}
				...
				\begin{center}
					\begin{longtable}{|p{3cm} |p{4cm} | p{4cm}|p{3cm} |p{2cm}|}
						...
						\hline
						\endlastfoot
						\textit{Anrede} & AuthenticateAction & ... & ... & ..\\ \hline
						\textit{Vorname} & AuthenticateAction & ... & ... & ..\\ \hline
						\textit{Nachname} & AuthenticateAction & ... & ... & ..\\ \hline
						\textit{Geburtsdatum} & AuthenticateAction & ... & ... & ..\\ \hline
						\textit{Straße} & AuthenticateAction & ... & ... & ..\\ \hline
						...
						\textit{Passwort wiederholen} & AuthenticateAction & ... & ... & ..\\ \hline
						\textit{E-Mail} & AuthenticateAction & ... & ... & ..\\ \hline
			...
			\item \textbf{Outputs:}
				...
				\begin{center}
					\begin{longtable}{|p{5cm} | p{4cm}|p{3cm}|}
						...
						\textit{Name Kursleiter Fehlermeldung}  & outputText & ... \\ \hline
						\textit{E-Mail-Adresse Kursleiter Fehlermeldung}  & outputText & ... \\ \hline
						\textit{Kursleiter-ID Fehlermeldung}  & outputText & ... \\ \hline
						\textit{Löschen Kursleiter Fehlermeldung}  & outputText & ... \\ \hline
						\textit{Kursleiter Tabelle}  & dataTable & ... \\ \hline
					\end{longtable}
				\end{center}
