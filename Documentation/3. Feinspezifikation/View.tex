\chapter{View}
			...
			\end{itemize}
				\begin{center}
					\begin{longtable}{|p{3cm} |p{4cm} | p{4cm}|p{3cm} |p{2cm}|}
						...
						\textit{Kursleiter Name (A)} & ... & InputTextValidator, validateRequired, validateLength (min = 1, max = 200) & - & cleadername\\ \hline
						\textit{Kursleiter E-Mail (A)} & ... & EMailValidator, validateRequired, validateLength (min = 5, max = 319) & - & cleadermail\\ \hline
						\textit{Kursbeschreibung (A)} & ... & InputTextValidator, validateLength (min = 0, max = 1000) & - & cdetails\\ \hline
						\textit{Minimale Teilnehmerzahl (A)} & ... & - & convertNumber & minparticipants\\ \hline
						\textit{Maximale Teilnehmerzahl (A)} & ... & - & convertNumber & maxparticipants\\ \hline
						\textit{Startdatum (A)} & ... & DateValidator, validateRequired & convertDateTime & begin\\ \hline
						\textit{Enddatum (A)} & ... & DateValidator, validateRequired & convertDateTime & end\\ \hline
					\end{longtable}
				\end{center}
			\item \textbf{Outputs:}
			\begin{itemize}
		...
		\begin{itemize}
			...
			\item \textbf{Buttons:} 
				\begin{itemize}
					\item Details: Über den Detailsbutton hinter dem jeweiligen Kurs gelangt der Benutzer auf die gewünschte Kursdetailseite. (\hyperlink{courseDetails}{courseDetails.xhtml})
				\end{itemize}
					 \begin{center}
					 	\begin{longtable}{|p{4cm} |p{6cm} | p{4cm}|}
					 		...
					 		\textit{Details} & loadCourseDetailsPageOf SelectedCourse() &  courseId (Id des ausgewählten Kurses wird übergeben) \\ \hline
					 	\end{longtable}
					 \end{center}
			...
			\item \textbf{Inputs:}
				...
				\begin{center}
					\begin{longtable}{|p{3cm} |p{6cm} | p{4cm}|p{3cm}|}
						...
						\textit{Straße/ Hausnummer} & UserProfilBean.Address.street, UserProfil.Address.houseNumber  & inputText & straße\\ \hline
				...
				\begin{center}
					\begin{longtable}{|p{3cm} |p{8cm} | p{5cm}|}
						...
						\textit{Straße/ Hausnummer} & validateLength (min = 0, max = 100) & - \\ \hline
						\textit{Stadt} & validateLength (min = 1, max = 100), validateRequired & -  \\ \hline
						\textit{Postleitzahl} & validateLength (min = 1, max = ???), validateRequired & - \\ \hline
						...
						\textit{Benutzername} & UserNameValidator, validateLength (min = 5, max = 100), validateRegex (pattern =""), validateRequired  & - \\ \hline
			...
			\end{itemize}
				\begin{center}
					\begin{longtable}{|p{3cm} |p{10cm} |}
						...
						\textit{Wochenansicht vorwärts} & - \\ \hline
						\textit{Wochenansicht rückwärts} & - \\ \hline
					\end{longtable}
				\end{center}
			\item \textbf{Buttons:} -
			\item \textbf{Inputs:} -
		...
		\begin{itemize}
			...
			\item \textbf{BackingBean:}
			\begin{itemize}
				\item ListParticipantsBean.java
			\end{itemize}
		\end{itemize}
			...
			\item \textbf{Inputs:}
				...
				\begin{center}
					\begin{longtable}{|p{3cm} |p{5cm} | p{4cm}|p{3cm}|}
						...
						\textit{Straße/ Hausnummer} & CourseUnitManagementBean. Address.street, CourseUnitManagement. Address.houseNumber & inputText & straße\\ \hline
				...
				\begin{center}
					\begin{longtable}{|p{3cm} |p{8cm} | p{5cm}|}
						...
						\textit{Kursleiter} & validateLength (min = ???, max = ???), validateRequired & -  \\ \hline
						...
						\textit{Benutzer-ID} & validateLength (min = , max = ), validateRequired & convertNumber \\ \hline
						\textit{Name (Teilnehmer)} & validateLength (min = , max = ), validateRequired & - \\ \hline
						\textit{Vorname (Teilnehmer)} & validateLength (min = , max = ), validateRequired & - \\ \hline
