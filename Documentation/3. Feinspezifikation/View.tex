			...
			\begin{itemize}
				...
				\begin{center}
					\begin{longtable}{|p{3cm} |p{4cm} | p{4cm}|p{3cm}|}
						...
						\hline
						\endlastfoot
							\textit{Anrede} & AuthenticateAction & inputText & Request\\ \hline
							\textit{Vorname} & AuthenticateAction & inputText & Request\\ \hline
							\textit{Name} & AuthenticateAction & inputText & Request\\ \hline
							\textit{Benutzername} & AuthenticateAction & inputText & Request\\ \hline
							\textit{Passwort} & AuthenticateAction & inputSecret & Request\\ \hline
							\textit{Passwort bestätigen} & AuthenticateAction & inputText & Request\\ \hline
							\textit{Geburtstag} & AuthenticateAction & inputText & Request\\ \hline
							\textit{Straße/Hausnummer} & AuthenticateAction & inputText & Request\\ \hline
							\textit{Stadt} & AuthenticateAction & inputText & Request\\ \hline
							\textit{Postleitzahl} & AuthenticateAction & inputText & Request\\ \hline
							\textit{Land} & AuthenticateAction & inputText & Request\\ \hline
							\textit{E-Mail-Adresse} & AuthenticateAction & inputText & Request\\ \hline
							\textit{AGBs bestätigen} & AuthenticateAction & inputText & Request\\ \hline
							\textit{Benutzername} & AuthenticateAction & inputText & Request\\ \hline
							\textit{Passwort} & AuthenticateAction & inputText & Request\\ \hline
							\textit{E-Mail-Adresse} & AuthenticateAction & inputText & Request\\ \hline
					\end{longtable}
				\end{center}
