\chapter{Klassendiagramm}
	...
	\kursiv{ManagedBean, RequestScoped}\\
	Die Klasse ist für die 'Passwort  vergessen' - Funktion zuständig, d.h. sie ersetzt das alte Passwort
	eines Benutzers durch ein zufällig generiertes und sendet es an die eingegebene E-Mailadresse.
	\begin{itemize}
	...
	\begin{itemize}
		...
		\item \method{public UserStatus setUserInactive()}
		\item \method{public String depositMoneyPerCreditcard()}
		\item \method{public User getUser()}
	...
	\begin{itemize}
		\item \method{public String editImprint()}
