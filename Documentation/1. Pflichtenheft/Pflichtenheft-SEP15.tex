		...
		\subsection{Grundfunktionen}
			\begin{itemize}
				\item \Func{Sicheres Einloggen ins System.} \hypertarget{login}
					Durch Eingabe des Benutzernamen, des Passworts und Klicken der 'Anmelden' - Schaltfläche kann sich der Benutzer ins System einloggen. Die Anmeldedaten werden dabei mittels SSL übertragen. Nach erfolgreichem Anmelden wird der Nutzer auf die 'Meine Kurse' - Seite weitergeleitet.
