...
\chapter{Produkteinsatz}
	...
	\section{Zielgruppen}
		 \begin{enumerate}
		 	...
		 	\begin{itemize}
		 		\item Anonymer Benutzer: Anonyme Benutzer benötigen rudimentäre Kenntnisse im Umgang mit dem Computer. Sie sollen einen \gls{Browser} steuern können, die Webseite des \gls{Einheiten}-Manager öffnen, um dort nach Veranstaltungen suchen und informieren zu können.
