...
\chapter{Globale Testszenarien und Testfälle}
	...
	\section{Testfälle für den registrierten Benutzer}
				...
				\begin{itemize}
					\item Hier gibt Kathi5 folgende Daten ein:
						 \begin{itemize}
						 	...
						 	\item Betrag: 'fünfzig'
						 \end{itemize}
					Anschließend klickt der Nutzer auf den Button 'Aufladen' und wird durch eine Fehlermeldung darauf hingewiesen, dass ein falsches Format im Eingabefeld 'Betrag' eingetragen wurde. Dieses Feld wird geleert, die anderen Eingaben bleiben erhalten.
		...
		!!!HIER GEHTS WEITER!!! 
				...
				Der Benutzer 'Kathi5' befindet sich auf der Seite 'Meine Kurse' und gelangt durch Klicken auf den Kurs 'Standardtanz' zur dessen Detailansicht.
