...
\end{tiny}
    ...
    \section{Navigation}
    In den Rechtecken der folgenden Grafik sind die 				verschiedenen Seiten der Webanwendung enthalten.
    \newline
    \newline
    \includegraphics[scale=0.25]{logo/Navigation.pdf}
    \newline
    
    Die Seiten sind  nach Farben aufgeteilt (entsprechend 			der Autorisierung des Nutzers), sodass die jeweilige 			Seite
    \begin{itemize}
    ...
    \newline
    Die Seiten 'Impressum', 'Hilfe' sowie die Startseite 			sind global erreichbar für alle Nutzer.
    \newline
    Für angemeldete Nutzer sind 'Suche', 'Meine Kurse', 			'Profil' sowie 'Terminplaner' über eine 						Navigationsleiste von jeder Seite aus 							erreichbar.
    \newline
    Bei Administratoren befindet sich in der 						Navigationsleiste zusätzlich ein Link zur Seite 				'Adminverwaltung'.
...
\end{tiny}
	...
	\begin{itemize}
	\item Der HTML Code wird durch den Validator
