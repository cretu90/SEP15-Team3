...
\chapter{Benutzeroberfläche}
    ...
    \section{Screenshots}
	    ...
	    \subsection{Startseite}
		    \includegraphics[scale=0.37]{index.png}
	    \subsection{Meine Kurse}
	    	\includegraphics[scale=0.37]{myCourses.png}
